...
RegisterCommand('test_gizmo',function(source, args, rawCommand)
    ...
    local model = args[1] or 'tr_prop_meth_phosphorus'
...
function keybinds.GetKeybinds()
    ...
    return {
        mode = {
            key = common.GetKeyLabel(keybinds.mode.hash),
            description = keybinds.mode.description,
        },
        focus = {
            key = common.GetKeyLabel(keybinds.focus.hash),
            description = keybinds.focus.description,
        },
        finish = {
            key = common.GetKeyLabel(keybinds.finish.hash),
            description = keybinds.finish.description,
        },
        cancel = {
            key = common.GetKeyLabel(keybinds.cancel.hash),
